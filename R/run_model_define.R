...
#'   [define_parameters()]. Parameters can be combined with function [c()]
...
#' created and the calling environment is recoreded. To be available from `run_model`,
...
#' use the objects of the calling environment, the object must be injected with 
