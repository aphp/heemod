...
The key element to specify time-varying elements in `heemod` is through the use of the **package-defined variables** `model_time` and `state_cycle`. See vignette `vignette("b-time-dependency", "heemod")` for more details.
