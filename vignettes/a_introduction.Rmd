...
Time varying transition probabilities and state values are available through the `model_time` and `state_cycle` variables. Time-varying probabilities and values are explained in `vignette("b-time-dependency", "heemod")`.
