...
Point 3. is reproduced by making `rr` and `cost_lami` a time changing variable like this `rr = ifelse(model_time <= 2, .509, 1.00)`.
...
It is important to inject the variables defined globally within the function 
`define_parameters()` with the argument `find`.
...
param <- define_parameters(
    ...
    # death_prob is defined in the global environment
